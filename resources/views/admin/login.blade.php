...
<body class="hold-transition login-page"
    style="background-image: url('<?= url('/') ?>/back/gambar/background.jpg');background-repeat: no-repeat;background-size: cover;">
    <div class="login-box" style="width: 500px;">
        <!-- /.login-logo -->
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <div class="row">
                    <div class="col-md-12"><img src="<?= url('/') ?>/back/gambar/logotravel.png" style="width: 100px;">
                    </div>
                    {{-- <div class="col-md-12"><a href="/" class="h1"><b>Login Admin</b></a></div> --}}
                    <h3 class="col-md-12"><b>Login Admin</b></h3>
                </div>
            </div>
            <div class="card-body">
                <h2 class="login-box-msg">PT AL FAZAR Tours</h2>
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="button" onClick="processLogin()" class="btn btn-primary btn-block">Sign
                            In</button>
                    </div>
                    <!-- /.col -->
                </div>
