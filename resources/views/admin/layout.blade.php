...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?= url('/') . '/back/gambar/logotravel.png' ?>"
                alt="PT Artha Medika Persada" height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <a href="" class="brand-link">
                ...
                <span class="brand-text font-weight-light">PT AL FAZAR Tours</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?= $activemenu == 'master' ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= url('/') . '/admin/jemaah.html' ?>"
                                        class="nav-link <?= $activesubmenu == 'jemaah' ? 'active' : '' ?>">
                                        <i class="far fa-user nav-icon"></i>
                                        <p>Jemaah</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= url('/') . '/admin/pembayaran.html' ?>"
                                        class="nav-link <?= $activesubmenu == 'pembayaran' ? 'active' : '' ?>">
                                        <i class="far fa-user nav-icon"></i>
                                        <p>Pembayaran</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= url('/') . '/admin/gallery.html' ?>"
                                        class="nav-link <?= $activesubmenu == 'gallery' ? 'active' : '' ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= url('/') . '/admin/profile.html' ?>"
                                        class="nav-link <?= $activesubmenu == 'profile_sekolah' ? 'active' : '' ?>">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 Travel.</strong>
            All rights reserved.
    ...
    <?php if ($activemenu == 'master' && $activesubmenu == 'jemaah') : ?>
    <script src="<?= url('/') ?>/back/js/jemaah.js"></script>
