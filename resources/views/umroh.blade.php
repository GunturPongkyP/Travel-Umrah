                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4" style="width: 100%;">
                                        <div class="card-body">
                                            <h2 class="card-title">Paket A | 12 Hari</h2>
                                            <h3><i class="fas fa-plane-departure"></i> Saudi Airline</h3>
                                            <h3><i class="fas fa-hotel"></i> Makkah dan Madinah</h3>
                                            <h3><i class="fas fa-dollar-sign"></i> Rp.35.000.000</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4" style="width: 100%;">
                                        <div class="card-body">
                                            <h2 class="card-title">Paket B | 10 Hari</h2>
                                            <h3><i class="fas fa-plane-departure"></i> Saudi Airline</h3>
                                            <h3><i class="fas fa-hotel"></i> Makkah dan Madinah</h3>
                                            <h3><i class="fas fa-dollar-sign"></i> Rp.32.000.000</h3>
                                            <a href="#" class="btn btn-primary">Detail</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <footer class="bg-dark text-light" style="background-color: #0C356A;">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; Copyright 2024. All Rights Reserved by <a href="#">PT AL FAZAR Tours Haji
                                dan
                                Umroh</a></p>
                    </div>
