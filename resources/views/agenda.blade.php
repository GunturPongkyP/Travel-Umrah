...
<body>
    ...
    <div class="breadcrumb-area shadow dark bg-fixed text-center text-light"
        style="background-image: url(<?= url('/') ?>/img/2440x1578.png);">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="item">
                                        <div class="info">
                                            <div class="meta">
                                                <ul>
                                                    <li><i
                                                            class="fas fa-calendar-alt"></i><?= date_format(date_create($value->tanggal), 'd F Y') ?>
                                                    </li>
                                                </ul>
                                            </div>
    ...
    <!-- Start Footer
    ============================================= -->
    <footer class="bg-dark text-light" style="background-color: #38B6FF;">
        <!-- Start Footer Bottom -->
